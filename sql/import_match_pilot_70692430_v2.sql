-- ====================================================================
-- RFEF · PASO 6E.1 · IMPORTACIÓN DEL PARTIDO PILOTO (VERSIÓN V2)
-- Partido: Athletic Club 6–0 UD Logroñés (Jornada 1 · 05/09/2026)
-- CodActa RFEF: 70692430
-- Archivo: sql/import_match_pilot_70692430_v2.sql
-- ====================================================================
-- MEJORAS DE SEGURIDAD DEFENSIVA EN V2:
-- 1. Precheck 1.3 reforzado: valida simultáneamente COUNT(*) = 36,
--    COUNT(DISTINCT rfef_player_id) = 36 y ausencia total de IDs con COUNT <> 1.
-- 2. Eliminación estricta de límites en subconsultas escalares de club_players,
--    garantizando fallo inmediato del motor ante cualquier duplicidad.
-- ====================================================================
...
DECLARE
    ...
    v_distinct_check INTEGER;
    v_anomalies_check INTEGER;
...
BEGIN
    ...
    -- 1.3. PRECHECK REFORZADO DE UNICIDAD: Verificar que los 36 rfef_player_id existen EXACTAMENTE UNA VEZ
    -- A) Total de filas = 36 y Total de IDs distintos = 36
    SELECT COUNT(*), COUNT(DISTINCT rfef_player_id) 
    INTO v_count_check, v_distinct_check
    FROM club_players 
    ...
    IF v_count_check <> 36 OR v_distinct_check <> 36 THEN
        RAISE EXCEPTION 'PRECHECK FALLIDO: Se esperaban exactamente 36 filas y 36 IDs únicos en club_players (filas: %, distintos: %)', v_count_check, v_distinct_check;
    END IF;

    -- B) Garantizar que ningún ID esperado tenga COUNT(*) <> 1
    SELECT COUNT(*) INTO v_anomalies_check
    FROM (
        SELECT rfef_player_id, COUNT(*) AS cnt
        FROM club_players
        WHERE rfef_player_id IN (
            1486871, 1527831, 1483391, 1536892, 1535327, 25167623, 25439141, 1515139, 25241049, 33129429, 1490940,
            1535326, 25099419, 1510590, 1483244, 1505560, 25241054, 1501389,
    ...
    IF v_anomalies_check > 0 THEN
        RAISE EXCEPTION 'PRECHECK FALLIDO: Se detectaron % rfef_player_id con duplicidades o anomalías en club_players', v_anomalies_check;
    END IF;
    ...
    -- 3.1. 18 Jugadores de Athletic Club,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1486871),
            v_athletic_club_id,
            13,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1527831),
            v_athletic_club_id,
            2,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1483391),
            v_athletic_club_id,
            5,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1536892),
            v_athletic_club_id,
            10,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1535327),
            v_athletic_club_id,
            12,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 25167623),
            v_athletic_club_id,
            14,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 25439141),
            v_athletic_club_id,
            17,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1515139),
            v_athletic_club_id,
            19,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 25241049),
            v_athletic_club_id,
            20,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 33129429),
            v_athletic_club_id,
            21,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1490940),
            v_athletic_club_id,
            24,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1535326),
            v_athletic_club_id,
            30,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 25099419),
            v_athletic_club_id,
            3,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1510590),
            v_athletic_club_id,
            4,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1483244),
            v_athletic_club_id,
            7,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1505560),
            v_athletic_club_id,
            15,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 25241054),
            v_athletic_club_id,
            18,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1501389),
            v_athletic_club_id,
            23,
            true,
            false,
    ...
    -- 3.2. 18 Jugadores de UD Logroñés,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 489124),
            v_logrones_club_id,
            13,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 25177199),
            v_logrones_club_id,
            3,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 23445453),
            v_logrones_club_id,
            4,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1346342),
            v_logrones_club_id,
            5,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1365893),
            v_logrones_club_id,
            8,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1511829),
            v_logrones_club_id,
            9,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1108391),
            v_logrones_club_id,
            11,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1361353),
            v_logrones_club_id,
            16,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1368621),
            v_logrones_club_id,
            20,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 885652),
            v_logrones_club_id,
            21,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1346348),
            v_logrones_club_id,
            22,
            true,
            true,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1361938),
            v_logrones_club_id,
            1,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1369428),
            v_logrones_club_id,
            6,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1362005),
            v_logrones_club_id,
            7,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1362760),
            v_logrones_club_id,
            10,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1368755),
            v_logrones_club_id,
            12,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 863015),
            v_logrones_club_id,
            14,
            true,
            false,
        ...
        (
            v_match_id,
            (SELECT id FROM club_players WHERE rfef_player_id = 1295765),
            v_logrones_club_id,
            18,
            true,
            false,
    ...
    WHERE official_match_id = v_match_id 
      AND club_player_id = (SELECT id FROM club_players WHERE rfef_player_id = 25177199)
      AND amarillas = 2
